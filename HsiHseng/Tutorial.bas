...
Sub Globals
	...
	Private my As Typeface : my = Typeface.LoadFromAssets("Hsi-Hseng.ttf")
	Dim AdView3 As AdView
End Sub

Sub Activity_Create(FirstTime As Boolean)
	AdView3.Initialize("AdView3","ca-app-pub-4173348573252986/1903160154")
	AdView3.LoadAd
...
Sub about_Click
	...
	i = Msgbox2("App Name: Hsi Hseng Font" &CRLF&CRLF& "Version: 1.0" &CRLF&CRLF& "Developed By: Khun Htetz Naing","About App","Rate App","","Ok",Null)
 If i = DialogResponse.POSITIVE Then
  StartActivity(p.OpenBrowser("https://play.google.com/store/apps/details?id=com.htetznaing.hsihsengfont"))
 End If
End Sub
...
Sub rate_Click
		Dim p As PhoneIntents
		StartActivity(p.OpenBrowser("https://play.google.com/store/apps/details?id=com.htetznaing.hsihsengfont&hl=es"))
End Sub
Sub more_Click
		Dim p As PhoneIntents
...
Sub share_Click
    ...
    ShareIt.PutExtra ("android.intent.extra.TEXT","'Hsi Hseng' Beautiful Myanmar Font Style Download at Google Play Store: https://play.google.com/store/apps/details?id=com.htetznaing.hsihsengfont&hl=es")
