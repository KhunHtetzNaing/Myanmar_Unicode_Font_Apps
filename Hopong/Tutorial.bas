...
Sub Globals
	...
	Private my As Typeface : my = Typeface.LoadFromAssets("hopong.ttf")
	Dim AdView3 As AdView
End Sub

Sub Activity_Create(FirstTime As Boolean)
	AdView3.Initialize("AdView3","ca-app-pub-4173348573252986/6054158157")
	AdView3.LoadAd
	...
	scl.Panel.AddView(txt4,0%x,(btni.Top+btni.Height)+2%y,100%x,110%y)
	scl.Panel.AddView(txt5,0%x,(txt4.Top+txt4.Height),100%x,33%y)
	scl.Panel.AddView(btnhi,20%x,(txt5.Top+txt5.Height),60%x,10%y)
	scl.Panel.AddView(txt6,0%x,(btnhi.Top+btnhi.Height)+2%y,100%x,190%y)
